...
local NAME_KLZ_XT = NAME_COLOR_BOSS..AL["The Failed Apprentice"]..":|r %s" -- Tempest Keep
local KEYS = {	-- Keys
	name = AL["Keys"],
...
data["Karazhan Crypts"]={
	...
	items = {
		...
		{ -- 学徒
			name = AL['Kaigy Maryla'],
			nameFormat=NAME_KLZ_XT,
			[SOD_DIFF] = {
				{1,235886},
				{2,235873},
				{3,235894},
...
data["TheRuinsofAhnQiraj"] = { -- AQ20
	...
	[SOD_DIFF] = {
		...
		{ 3,  234116 }, -- Polished Obsidian Pauldrons
	...
	items = {
		...
		{ -- AQ40Viscidus
			...
			[SOD_DIFF] = {
        		...
        		{ 21, 233371 }, -- Qiraji Bindings of Dominance
			},
			[NORMAL_DIFF] = {
		...
		{ -- AQ40Emperors
			...
			[SOD_DIFF] = {
				...
				{ 10, 233365 }, -- Imperial Qiraji Armaments
				{ 11, 233367 }, -- Imperial Qiraji Armaments
				{ 12, 233368 }, -- Imperial Qiraji Armaments
				...
				{ 26, 235046 }, -- Imperial Qiraji Regalia
				{ 27, 235045 }
			},
			[NORMAL_DIFF] = {
				{ 1, "INV_Box_01", nil, AL["Emperor Vek'lor"], nil },
	...
	items = {
			...
			{ -- NAXAnubRekhan
					...
					[NORMAL_DIFF] = {
							...
							{ 16, 236226}, -- Gem of Nerubis
							{ 17, 236228}, -- Gem of Nerubis
					},
			...
			{ -- NAXNoththePlaguebringer
					...
					[NORMAL_DIFF] = {
							...
							{ 16, 236229}, -- Hatchet of Sundered Bone
							{ 17, 236230}, -- Hatchet of Sundered Bone
					},
			},
			{ -- NAXHeigantheUnclean
					...
					[NORMAL_DIFF] = {
							...
							{ 16, 236219}, -- Hatchet of Sundered Bone
			...
			{ -- NAXLoatheb
					...
					[NORMAL_DIFF] = {
							...
							{ 16, 22708}, -- Hatchet of Sundered Bone
			...
			{ -- NAXInstructorRazuvious
					...
					[NORMAL_DIFF] = {
							...
							{ 16, 236220}, -- Hatchet of Sundered Bone
			...
			{ -- NAXGothiktheHarvester
					...
					[NORMAL_DIFF] = {
							...
							{ 16, 236225}, -- Hatchet of Sundered Bone
							{ 17, 236227}, -- Hatchet of Sundered Bone
					},
			},
			{ -- NAXTheFourHorsemen
			...
			{ -- NAXPatchwerk
					...
					[NORMAL_DIFF] = {
							...
							{ 12, 236287}, -- Severance
							{ 16, 236222}, -- Hatchet of Sundered Bone
			...
			{ -- NAXGrobbulus
					...
					[NORMAL_DIFF] = {
							...
							{ 16, 236221}, -- Hatchet of Sundered Bone
			...
			{ -- NAXSapphiron
					...
					[NORMAL_DIFF] = {
							...
							{ 21, 236242},
							{ 22, 236251}, -- Desecrated Tunic
							{ 23, 236231}, -- Desecrated Breastplate
					},
			},
			{ -- NAXKelThuzard
					name = AL["Kel'Thuzad"],
					...
					[NORMAL_DIFF] = {
							...
							{ 16, 236350}, -- The Phylactery of Kel'Thuzad
							{ 18, 237381}, -- Ring of Faith
							{20,236662},
							{21,236663},
							{22,236664},
							{23,236665},
...
data["Scarlet Enclave"] = {
	MapID = 2856,
	InstanceID = AtlasLoot:GameVersion_LT(AtlasLoot.WRATH_VERSION_NUM,2856,nil),
	AtlasModule = ATLAS_MODULE_NAME,
	name ='血色领地',
	ContentType = RAID_CONTENT,
	ContentPhase = 8,
	...
	items = {
		...
		},
		{
			name = '重生议会',
			[SOD_DIFF] = {
				{ 1, "INV_Box_01", nil, "杜安", nil },
				{ 2,"INV_Box_01", nil, "赫洛德", nil },
				{ 3,"INV_Box_01", nil, "韦沙斯", nil },
				{4,239117},
				{5,239216},
		...
		},
		{
			...
			{ -- NAXAnubRekhan
					...
					[SOD_DIFF] = {
						...
						-- {1,241082},
						{2, 236317},
						{3,238945},{4,238961},{5,239010},{6,239060},{7,239061},{8,239301},{9,240174},{10,240195},{11,240837},{12,240839},{13,240841},{14,240842},{15,240843},{16,240844},{17,240849},{18,240850},{19,240851},{20,240852},{21,240853},{22,240854},{23,240919},{24,240920},{25,240921},{26,240922},{27,240923},{28,240924},{29,240925},
						{ 30, "INV_Box_01", nil, "翻页-->", nil },{100,241158},
						{100,240936},{101,240997},{102,240998},{103,241001},{104,241002},{105,241003},{106,241004},{107,241006},{108,241008},{109,241011},{110,241012},{111,241081}
		...
		{28,241173},
		{29,241174},
		{ 30, "INV_Box_01", nil, "翻页-->", nil },{100,241175},
		{101,241176},
				},
			},
		{
		...
		{28,241163},
		{29,241164},
		{ 30, "INV_Box_01", nil, "翻页-->", nil },{100,241165},
		{101,241166},
				},
			},
		{
		...
		{28,241074},
		{29,241075},
		{ 30, "INV_Box_01", nil, "翻页-->", nil },{100,241076},
		{101,241077},
		{102,241078},
				},
			},
		...
		{28,241079},
		{29,241080},
		{ 30, "INV_Box_01", nil, "翻页-->", nil },{100,241152},
		{101,241153},
		{102,241154},
				},
			},
		...
		{28,241183},
		{29,241184},
		{ 30, "INV_Box_01", nil, "翻页-->", nil },{100,241185},
		{101,241186},
		{102,241187},
				},
			},
		...
		{28,241167},
		{29,241168},
		{ 30, "INV_Box_01", nil, "翻页-->", nil },{100,241170},
		{101,241171},
		{102,241172},
				},
			},
		...
		{28,241177},
		{29,241178},
		{ 30, "INV_Box_01", nil, "翻页-->", nil },{100,241179},
		{101,241180},
		{102,241181},
		{103,241182},
				},
