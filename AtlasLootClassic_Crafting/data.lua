	...
	items = {
		{
			...
			{16,1213481},
			{ 17, 1213484 }, -- Razorspike Shoulderplate
			{ 18, 1213490 }, -- Razorspike Battleplate
			{ 19, 1214309 }, -- Dreamscale Visor
...
data["Engineering"] = {
	...
	items = {
			...
			[NORMAL_DIFF] = {
				...
				{ 26, 1217207 }, -- Tuned Force Reactive Disk
				{ 28, "INV_Box_01", nil, AL["Phase 6"], nil },
				{ 29, 1221012},
			}
		},
		{
